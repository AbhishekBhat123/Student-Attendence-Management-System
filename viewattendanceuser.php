...
<div class="container-fluid view_user">
 ...
 <div class="col-sm-12">
  ...
  <p class="text-center">Enter your StdID and submit.</p>
 </div> 
 <div class="col-sm-12 user_form_color">
 
  <form class="form-inline" action="" method="post">
    <div class="form-group">
      <label for="email">Std_ID:</label>
      <input type="text" class="form-control" name="eid" placeholder="Enter Std_ID" required>
    </div>
...
$con = mysqli_connect('localhost','root','','attendance');
 ...
 <div class="container-fluid MT-10" style="background-color:lavenderblush";>
          ...
          <h1 class="h1_index text-center">Attendance can be seen below.</h1>
		   ...
		   <br>
<h4 class="text-center">Students can find there Std_ID here and can use Std_Id to view there attendance</h4>
