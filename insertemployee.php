 ...
 if(isset($_POST['submit'])) {
   ...
   if (mysqli_query($con,$sql))
  {
   ...
   <script>
	  ...
	  if(!alert('Students added successfully.')){window.location = "admin.php?view_employee=view_employee";}
   </script>
   <?php
       } 
   else {
    ?>
     <script>
       // window.location = "admin.php?view_employee=view_employee";
          if(!alert("Can not add students. Some error occured")){window.location = "admin.php?view_employee=view_employee";}
